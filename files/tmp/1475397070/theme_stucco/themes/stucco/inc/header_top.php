...
<!--[if gt IE 8]><!--> <html class="no-js" lang="<?php   echo Localization::activeLanguage()?>"> <!--<![endif]-->
    ...
    <body class="<?php   echo $c->getCollectionHandle(); ?><?php  global $u; $v = View::getInstance(); if (Config::get('concrete.user.profiles_enabled') && $u->isRegistered()) { echo ' add-account-menu'; } ?>">
